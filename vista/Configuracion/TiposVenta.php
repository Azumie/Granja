<div class="modal fade" id="TiposVenta">
	<div class="modal-dialog modal-fluid" role="document">
		<div class="modal-content">
			<div class="modal-header iconosModales mt-2 mt-md-0">
				...
				<h4 class="modal-title mt-3 ml-2">Tipos de Venta</h4>
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-lg-5 mb-3 mb-lg-0 ">
						...
						<div class="input-group mb-3">
						  	<div class="input-group-prepend">
						    	<label for="nombreTipoVenta" class="input-group-text">
						    		Nombre
						    	</label>
						  	</div>
						  	<input class="form-control" type="text" id="nombreTipoVenta" name="nombreTipoVenta"></input>
						</div>
					...
					<div class="col-lg-7">
						<table class="datatable table table-striped table-responsive-lg p-0 tablas table-sm">
